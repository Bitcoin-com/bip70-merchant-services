    ...
    module: {
      rules: [
        ...
        },
        {
          ...
          loader:
            "url-loader?limit=5000&hash=sha512&digest=hex&size=16&name=images/[name]-[hash].[ext]"
        },
        {
          test: /\.(woff|woff2|eot|ttf)($|\?)/,
          // embed images and fonts smaller than 5kb
          loader:
            "url-loader?limit=5000&hash=sha512&digest=hex&size=16&name=fonts/[name]-[hash].[ext]"
        }
      ]
    },
